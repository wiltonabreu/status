                        ...
                        <div class="col-md-4">
                            <ul>
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    Plesk linux 1
                                        <label class="switch ">
                                        <input type="checkbox" class="primary" value="1" <?php if( $incidentes["category_hospedagem_lin1"] == 1  ){ ?>checked<?php } ?> id="category_hospedagem_lin1" name="category_hospedagem_lin1">
                                        <span class="slider round"></span>
                                        </label>
                                    </li>
                                    ...
                                    Plesk linux 3
                                        <label class="switch ">
                                        <input type="checkbox" class="primary" value="1" <?php if( $incidentes["category_hospedagem_lin3"] == 1  ){ ?>checked<?php } ?> id="category_hospedagem_lin3" name="category_hospedagem_lin3">
                                        <span class="slider round"></span>
                                        </label>
                                    </li>
                                    <li class="list-group-item">
                                    Plesk Windows
                                        <label class="switch ">
                                        <input type="checkbox" class="primary" value="1" <?php if( $incidentes["category_hospedagem_win"] == 1  ){ ?>checked<?php } ?> id="category_hospedagem_win" name="category_hospedagem_win">
                                        <span class="slider round"></span>
                                        </label>
                                    </li>
                                </ul>
