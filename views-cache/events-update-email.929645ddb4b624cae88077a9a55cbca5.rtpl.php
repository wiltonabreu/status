        ...
        <section class="content">
          ...
          <div class="row">
              <div class="col-md-12">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="/admin/events/<?php echo htmlspecialchars( $incidentes["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $incidentes["idsubcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
                        ...
                        <div class="col-md-4">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item hidden">
                                    EMAIL
                                    <label class="switch ">
                                    <input type="checkbox" class="primary primary_email" value="category_email" <?php if( $incidentes["category_email"] != ''  ){ ?>checked<?php } ?> id="category_email"  name="category_email">
                                ...
                                <li class="list-group-item">
                                    IMAP
                                    <label class="switch ">
                                    <input type="checkbox" class="primary primary_email" value="category_email_imap" <?php if( $incidentes["category_email_imap"] != ''  ){ ?>checked<?php } ?>   id="category_email_imap" name="category_email_imap">
                                    <span class="slider round"></span>
                                    </label>
                                </li>
                                <li class="list-group-item">
                                    POP
                                    <label class="switch ">
                                    <input type="checkbox" class="primary" value="category_email_pop" <?php if( $incidentes["category_email_pop"] != ''  ){ ?>checked<?php } ?>  id="category_email_pop" name="category_email_pop">
                                    <span class="slider round"></span>
                                    </label>
                                </li>
                                <li class="list-group-item">
                                    SMTP
                                    <label class="switch ">
                                    <input type="checkbox" class="primary" value="category_email_smtp" <?php if( $incidentes["category_email_smtp"] != ''  ){ ?>checked<?php } ?> id="category_email_smtp" name="category_email_smtp">
                                    <span class="slider round"></span>
                                    </label>
                                </li>
                                <li class="list-group-item">
                                    WEBMAIL
                                    <label class="switch ">
                                    <input type="checkbox" class="primary" value="category_email_webmail" <?php if( $incidentes["category_email_webmail"] != ''  ){ ?>checked<?php } ?> id="category_email_webmail" name="category_email_webmail">
                                    <span class="slider round"></span>
                                    </label>
                                </li>
                                <li class="list-group-item">
                                    FILA
                                    <label class="switch ">
                                    <input type="checkbox" class="primary" value="category_email_fila" <?php if( $incidentes["category_email_fila"] != ''  ){ ?>checked<?php } ?> id="category_email_fila" name="category_email_fila">
                                    <span class="slider round"></span>
                                    </label>
                                </li>
                                <li class="list-group-item">
                                    Colaboração
                                    <label class="switch ">
                                    <input type="checkbox" class="primary" value="category_email_eas" <?php if( $incidentes["category_email_eas"] != ''  ){ ?>checked<?php } ?> id="category_email_eas" name="category_email_eas">
                                    <span class="slider round"></span>
                                    </label>
                                </li>
                            </ul>
                        ...
                        <div class="col-md-4">
                            <ul>
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    MAIL 01
                                        <label class="switch ">
                                        <input type="checkbox" class="primary" value="mail01" <?php if( $incidentes["category_email_mail01"] != ''  ){ ?>checked<?php } ?> id="category_email_mail01" name="category_email_mail01">
                                        <span class="slider round"></span>
                                        </label>
                                    </li>
                                    ...
                                    MAIL 02
                                        <label class="switch ">
                                        <input type="checkbox" class="primary" value="mail02" <?php if( $incidentes["category_email_mail02"] != ''  ){ ?>checked<?php } ?> id="category_email_mail02" name="category_email_mail02">
                                        <span class="slider round"></span>
                                        </label>
                                    </li>
                                    <li class="list-group-item">
                                    MAIL 03
                                        <label class="switch ">
                                        <input type="checkbox" class="primary" value="mail03" <?php if( $incidentes["category_email_mail03"] != ''  ){ ?>checked<?php } ?> id="category_email_mail03" name="category_email_mail03">
                                        <span class="slider round"></span>
                                        </label>
                                    </li>
                                </ul>
