                    ...
                    <div class="box-body"> <!-- class="box-body" -->
                        ...
                        <div class="col-md-4">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item ">                                    
                                    <label class="switch ">
                                    <input  type="checkbox" class="primary primary_email" value="1" <?php if( $incidentes["category_backup"] == 1  ){ ?>checked<?php } ?> id="category_backup" name="category_backup">
                        ...
                        <div class="col-md-4">                         
                            ...
                            <div class="form-group" id="http">
                                <label for="previsao"><h3>Previsão backup</h3></label>
                                <input type="text" class="form-control" id="previsao_backup" value="<?php echo htmlspecialchars( $incidentes["previsao_backup"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" name="previsao_backup" placeholder="Digite a previsao" style="width: 150px">
                            </div>
